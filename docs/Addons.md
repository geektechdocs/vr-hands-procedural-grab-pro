...
<p align="center">
  ...
  <a href="https://www.fab.com/listings/d073f170-0f69-4def-896d-45e2b44e55b4" target="_blank" rel="noopener">
    <img src="https://img.shields.io/badge/Get%20on%20Fab-VR74_Rifle_AddOn-009688?logo=unrealengine&style=for-the-badge" alt="Get on Fab">
  </a>
...
Designed for Unreal Engine 5 VR projects, this add-on provides a production-ready rifle interaction framework



[PLAYABLE DEMO](https://drive.google.com/drive/folders/1aq_lYhpWaNYBSXpTJMj7lvoEe7aCVyX5?usp=sharing){ target="_blank" }

[FAB PAGE](https://www.fab.com/listings/d073f170-0f69-4def-896d-45e2b44e55b4){ target="_blank" }

⚠️ [VR Hands Procedural Grab Pro Plugin](https://www.fab.com/listings/0d7009c6-ad1b-41d0-96d0-56ae95e59653){ target="_blank" } is required for this framework!

🔧 Core Features

- Niagara Decal Spawning (Pooling System)
- Digital Bullet Counter
- Functional bolt pull and release system
- Magazine extraction and insertion mechanics
- Safety switch state logic
...
- Add asset to your project
  <p align="left">
  <img src="/ScreenShots/AddToProjectVR74.jpg"
       alt="Add To Project"
       style="display:block; margin:8px 0; width:30%; max-width:900px;">
</p>
---

## 📦 Climbing Movement Add-On

<p align="center">
  <iframe 
    width="900" 
    height="506" 
    src="https://www.youtube.com/embed/v0_tlmy9Qgk?si=ozgUPV4PQ7KaR-DY" 
    title="Youtube video player" 
    frameborder="0" 
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
    allowfullscreen 
...
<p align="center">
  ...
  <a href="https://www.fab.com/listings/f941dd52-05b1-4276-ac53-f0bb389f83b5" target="_blank" rel="noopener">
    <img src="https://img.shields.io/badge/Get%20on%20Fab-Climbing_Addon-009688?logo=unrealengine&style=for-the-badge" alt="Get on Fab">
  </a>
...
No canned animations. No fake movement.
Just true procedural climbing.



[PLAYABLE DEMO](https://drive.google.com/drive/u/1/folders/1OoXpWpkAqlPw6gEP5s_Xr75Qv5koTu27){ target="_blank" }

[FAB PAGE](https://www.fab.com/listings/f941dd52-05b1-4276-ac53-f0bb389f83b5){ target="_blank" }
...
- Add **`ClimbingMovement`** component to your VR Pawn  
- Add tag **`CanClimb`** to any climbable actor  
- Change movement for all components inside climbable actor from **`Movable`** to **`Static`**
---